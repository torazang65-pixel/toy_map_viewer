...
std::string CoordinateConverter::getJsonPath(int sensor_id, int frame_index) {
    return base_dir_ + "sensor/" + std::to_string(sensor_id) + "/pandar64_0/ego_state/" + std::to_string(frame_index) + ".json";
}

std::string CoordinateConverter::getPcdPath(int sensor_id, int frame_index) {
    return base_dir_ + "sensor/" + std::to_string(sensor_id) + "/pandar64_0/pcd/" + std::to_string(frame_index) + ".pcd";
}
...
void CoordinateConverter::run() {
    // 1. 파일 검색
    std::string ego_state_dir = base_dir_ + "sensor/" + std::to_string(sensor_id_) + "/pandar64_0/ego_state/";
