#ifndef REALTIME_LINE_GENERATOR_REALTIME_VOXEL_MANAGER_H
#define REALTIME_LINE_GENERATOR_REALTIME_VOXEL_MANAGER_H
...
public:
    ...
    std::vector<ldb::data_types::Point> getFilteredPoints(uint32_t min_density_threshold);
